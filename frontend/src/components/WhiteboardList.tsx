    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">My Whiteboards</h1>
              ...
              >
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                    <span className={`w-2 h-2 rounded-full ${String(whiteboard.owner) === String(user?.id) ? 'bg-blue-500' : 'bg-purple-500'}`}></span>
                    <span>{String(whiteboard.owner) === String(user?.id) ? 'Owner' : 'Collaborator'}</span>
                  </div>
                ...
                <div className="flex gap-2 mt-auto">
                  ...
                  {String(whiteboard.owner) === String(user?.id) && (
                    <button
